...
def init_docker():
    subprocess.run(["sudo", "docker", "stop", "kali4"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    subprocess.run(["sudo", "docker", "rm", "kali4"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
